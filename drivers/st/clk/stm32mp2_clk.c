...
static const struct clk_stm32 stm32mp25_clk[CK_LAST] = {
	...
	GATE(_CK_SRAM1, CK_BUS_SRAM1, _CK_ICN_HS_MCU, 0, RCC_SRAM1CFGR, 1),
	GATE(_CK_SRAM2, CK_BUS_SRAM2, _CK_ICN_HS_MCU, 0, RCC_SRAM2CFGR, 1),
	...
	GATE(_CK_USB3DR, CK_BUS_USB3DR, _CK_ICN_HSL, 0, RCC_USB3DRCFGR, 1),
	...
	GATE(_CK_USBTC, CK_KER_USBTC, _CK_FLEXGEN_35, 0, RCC_USBTCCFGR, 1),
